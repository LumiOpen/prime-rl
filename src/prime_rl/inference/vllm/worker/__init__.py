...
_apply_patch(monkey_patch_LRUCacheWorkerLoRAManager)
# Monkeypatch MiniMaxM2 MoE gate dtype and adapter key mapping for LoRA compatibility
_apply_patch(monkey_patch_minimax_m2_for_lora)
...
try:
    ...
    _apply_patch(monkey_patch_fused_moe_lora_dp)
except ImportError:
    pass  # FusedMoEKernel not available in ROCm vLLM builds
