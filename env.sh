export PYTHONUSERBASE=/shared_silo/scratch/kahakala/lib/prime-rl-upstream/pythonuserbase
...
export TRITON_CACHE_DIR=/shared_silo/scratch/kahakala/lib/prime-rl-upstream/triton_cache
export XDG_CACHE_HOME=./xdg_cache
export TORCHINDUCTOR_CACHE_DIR=./torchinductor_cache
export PATH=$PYTHONUSERBASE/bin:$PATH
export UV_CACHE_DIR=./uv_cache

export UV_PYTHON=/shared_silo/scratch/kahakala/lib/prime-rl-upstream/.venv/bin/python3
